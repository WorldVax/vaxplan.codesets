...
exports.Antigens = lutFactory.New(antigenList, 'antigen');
...
exports.LiveVirusConflicts = lutFactory.New(lvc, 'cvx');
...
exports.Contraindications = lutFactory.New(ci, 'antigen');
exports.VaccineGroups = lutFactory.New(codesets.scheduleSupportingData.vaccineGroups[0].vaccineGroup, 'name');
exports.VaccineGroupToAntigenMap = lutFactory.New(codesets.scheduleSupportingData.vaccineGroupToAntigenMap[0].vaccineGroupMap, 'name');
exports.CvxToAntigenMap = lutFactory.New(codesets.scheduleSupportingData.cvxToAntigenMap[0].cvxMap, 'cvx');
